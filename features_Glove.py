...
def compute_NLP_features(data, queries):
    ...
    d = load_vectors(240000, 'glove6B/glove.6B.200d.txt')
...
#            break
    ...
    NLP_data = pd.DataFrame(NLP_data, columns=["Glove-COSINE"])
...
# Save to csv
training_data_NLP.to_csv('training_data_NLP_GLOVE_240000.csv')
